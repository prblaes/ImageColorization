...
if __name__ == '__main__':
    ...
    training_files = ['/shared/users/prblaes/ImageColorization/images/cats/cats3.jpg']

    input_files = glob('/shared/users/prblaes/ImageColorization/images/cats/*.jpg')

    output_dir = '/shared/users/prblaes/ImageColorization/output/cats/'
